function readOutput(stmt) {
	...
	sheet.appendRow([
		...
		"TRUE",
		"TRUE",
		"Please ask latecomers and people not on the list to sign up right now at www.climbingclan.com and show you their confirmation page or confirmation email on their phone (or borrowed phone)",
	]);
	sheet.appendRow([
		"",
		"TRUE",
		"TRUE",
		"TRUE",
		"Once you've seen their confirmation page or email, you can add them below this line",
	]);
	sheet.appendRow([
		"",
		"TRUE",
		"TRUE",
		"TRUE",
		"Do this even with people who say they've already signed up",
	]);
	sheet.appendRow([
		"",
		"TRUE",
	...
	// Insert checkboxes
	const range = sheet.getRange("B2:D150");
